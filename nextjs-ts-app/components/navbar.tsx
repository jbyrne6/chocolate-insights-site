...
import Logo from '../public/ci-logo.png'
import LogoIcon from '../public/cocoa-icon-cropped.png'

const solutions = [
  {
    name: 'Bean-to-Bar QR (coming soon)',
    description: 'Tell the full story of your chocolate to customers.',
    href: '#',
    icon: QrcodeIcon,
  },
  {
    name: 'Chocolate Discovery (coming soon)',
    description: 'Discover craft chocolate anywhere in the world.',
    href: '#',
    icon: MapIcon,
  },
]
              ...
              <div className="flex items-center justify-between">
                <div>
                  {/* <img
                    ...
                    alt="Chocolate Insights Logo icon"
                  /> */}
                  <Image
                    className="h-8 w-auto"
                    src={LogoIcon}
